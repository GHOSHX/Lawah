...
document.addEventListener('DOMContentLoaded', () => {
    ...
    addRow1Btn = document.getElementById('add-character-btn');
    ...
    addRow1Btn.addEventListener('click', generateRow);
    addRow2Btn.addEventListener('click', generateRow2);
        ...
        if (articleData) {
            ...
            characters.forEach(character => {
                ...
                if (character.type === 'category') {
                  ...
                  template = document.getElementById('character-template').content.cloneNode(true);
